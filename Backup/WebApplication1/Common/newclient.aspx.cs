    ...
    public partial class newclient : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (solu.Contains("Sucess"))
            {
                ...
                msg.From = new MailAddress("bibink549@gmail.com", "soft solution");
                ...
                smtp.Credentials = new NetworkCredential("bibink549@gmail.com", "9747329202");
        ...
        protected void ddl_country_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var type = obj.tbl_state.Where(x => x.country_id == cntryid);
